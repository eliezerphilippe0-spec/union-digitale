        ...
        try {
            ...
            if (currentUser) {
                const transactionId = await logTransaction({
                    ...
                    type: TRANSACTION_TYPES.RECHARGE_NATCASH,
                    amount: formData.montant,
                    phoneNumber: formData.numeroNatCash,
                    metadata: {
                        service: 'NatCash Recharge',
                ...
                setTimeout(() => {
                    ...
                    setShowSuccess(true);
                    setTransactionRef(`NCH${Date.now().toString().slice(-8)}`);
            ...
            <div className="service-page">
                <div className="service-container">
                    <div className="success-animation">
                        ...
                        <p>Votre compte NatCash a été rechargé</p>
                        <div className="success-details">
                            <p><strong>Numéro:</strong> {formData.numeroNatCash}</p>
        ...
        <div className="service-page">
            ...
            <div className="service-container">
                ...
                <nav className="breadcrumb">
                    ...
                    <span className="breadcrumb-separator">/</span>
                    <span className="breadcrumb-current">Recharge NatCash</span>
                </nav>
                ...
                <div className="service-header">
                    <div className="service-icon-wrapper">
                        <CreditCard className="service-icon" size={48} />
                    </div>
                    <div className="service-header-content">
                        <h1 className="service-title">Recharge NatCash</h1>
                ...
                <div className="quick-info">
                    ...
                    <div className="info-item">
                        ...
                        <div>
                            ...
                            <div className="info-value">OTP requis</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="service-description">
                    <p>Ajoutez du crédit à votre compte NatCash instantanément avec vérification OTP.</p>
                </div>

                {/* Form */}
                <form onSubmit={handleSubmit} className="service-form">
                    <div className="form-group">
                        <label htmlFor="numeroNatCash">
                            <Phone size={18} />
                            Numéro NatCash
                        </label>
                        <input
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className="form-input"
                        />
                        <small className="form-hint">Code à 6 chiffres envoyé par SMS</small>
                    </div>
                ...
                <div className="security-notice">
                    <Shield size={20} />
                    <p>Transaction sécurisée avec authentification OTP. Vos données sont protégées.</p>
                </div>
            </div>
        </div>
    );
...
export default RechargeNatCash;
