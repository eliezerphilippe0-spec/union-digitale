...
const PICKUP_POINTS = [
    {
        id: 'pp_1',
        name: 'Zabely Point - Pétion-Ville',
        type: 'zabely_store',
    ...
    {
        id: 'pp_4',
        name: 'Zabely Locker - Centre-ville',
streams: 'locker',
...
const POINT_TYPES = {
    zabely_store: { label: 'Zabely Store', color: 'bg-gold-500', icon: '🏪' },
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="p-4 border-b border-gray-100 space-y-3">
                ...
                <div className="flex gap-2 overflow-x-auto pb-1">
                    {[
                        { key: 'all', label: 'Tous' },
                        { key: 'zabely_store', label: '🏪 Zabely Store' },
            ...
            <div className="p-4 bg-gradient-to-r from-gold-50 to-amber-50 border-t border-gold-100">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-600">Retrait gratuit dans tous les points Zabely</p>
                    </div>
                </div>
            </div>
        </div>
