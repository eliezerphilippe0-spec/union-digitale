        ...
        <footer className="bg-gradient-to-b from-primary-900 to-primary-950 text-white mt-auto">
            ...
            <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li>
                            <Link to="/sell-on-zabely" className="text-neutral-200 hover:text-gold-400 transition-colors font-medium">
                                {t('sell_on_zabely') || 'Vendez sur Zabely'}
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link to="/zabely-logistics/join" className="text-indigo-400 hover:text-indigo-300 transition-colors font-bold flex items-center gap-1">
                                <Truck className="w-4 h-4" />
                                {t('zabely_solution_driver') || 'Livreur Zabely Solution'}
                            </Link>
                        </li>
                        <li>
